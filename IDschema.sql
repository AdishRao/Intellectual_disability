...
/*!50003 CREATE */ /*!50017 DEFINER=`root`@`localhost` */ /*!50003 TRIGGER `dele_age` BEFORE INSERT ON `Child` FOR EACH ROW BEGIN
   IF NEW.AGE < 6 or NEW.AGE > 9 THEN
   delete from Child where UID = NEW.UID;
   END IF;
END */;;
DELIMITER ;
...
-- Dump completed on 2018-12-05 16:24:47
